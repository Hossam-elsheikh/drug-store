...
export default function NotFound({ mode }: { mode?: string }) {
    ...
    return (
        <div className={`flex flex-col items-center justify-center ${isDrawerMode ? 'h-full' : 'min-h-screen'} text-center p-4 bg-gray-50 w-full rounded-lg`}>
            <Image
                src={imageNotFound}
                ...
                priority
            />
            <h1 className={`mt-4 ${isDrawerMode ? 'text-xl' : 'text-3xl'} font-bold text-gray-800`}>
