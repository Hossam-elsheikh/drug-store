            ...
            <Dialog >
                <DialogTrigger asChild>
                    <Button
                        className={`
        ${mode === 'add'
                                ? 'rounded-full items-center gap-2 px-3 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 shadow-sm hover:bg-gray-50 focus:outline-none duration-200'
