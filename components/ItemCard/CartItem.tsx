...
function CartItem({Price,image,Title,Description}:CartProps) {
    ...
    return (<>
        ...
        <div className="rounded-lg border border-gray-200 bg-white  dark:border-gray-700 dark:bg-gray-800 md:p-3 shadow-md">
            <div className="space-y-2 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                <a href="#" className="shrink-0 md:order-1">
                    <Image width={210} height={210} className="w-full object-cover rounded-lg" src="https://t3.ftcdn.net/jpg/01/02/12/28/240_F_102122850_fj76MXJcEDP4OzO2y918KarKygSeFmZk.jpg" alt="imac image" />
