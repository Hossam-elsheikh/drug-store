                    ...
                    <div className="fixed inset-0 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="flex flex-col md:flex-row">
                                ...
                                <div className="w-full md:w-1/2 p-8 space-y-6">
                                    <DialogTitle className="text-2xl font-bold text-gray-800">
                                        <h1 className="font-base text-sm">{brand?.name?.[locale]}</h1>
                                        <Link href={''} className="hover:text-secColor transition-colors duration-200">
                                            {name?.[locale]}
                                        </Link>
                                    </DialogTitle>
                                    ...
                                    <div className="space-y-2">
                                        <p className="text-2xl font-bold text-secColor">
                                    ...
                                    <div className="flex gap-4 pt-6">
                                        ...
                                        >
                                          ...
                                          <button className="flex-1 px-6 py-3 bg-secColor text-white rounded-full hover:bg-opacity-90 active:scale-95 transition-all duration-200 flex items-center justify-center gap-2"
                            ...
                            <Eye className="w-5 h-5" />
                                        ...
                                        >
                     <Heart size={20}  className={` transition-all duration-300 delay-400 ${
