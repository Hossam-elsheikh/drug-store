    ...
    return (
        <section dir={dir} className={twMerge(` mx-2 my-5 md:my-9 lg:mx-auto w-full px-2 lg:px-0 lg:w-4/5   max-w-[980px]  ${dir && 'gap-2'}`, className)}>
            ...
            {title && (
                ...
                <button className="flex w-fit px-4 py-2 rounded-full bg-primaryColor text-slate-100 font-medium  hover:bg-secColor transition duration-300">View More</button>
                </div>
