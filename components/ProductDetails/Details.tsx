        ...
        >
            <div className="space-y-3">
                ...
                <div dir={dir} className="flex items-center justify-between">
                    <h5 dir={dir} className="mt-1  flex gap-1 items-end text-2xl font-semibold text-secColor">
                        {price}
                ...
                <RatingProd
                    averageRate={productReviewQuery?.data?.averageRate}
                />
            </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center gap-3">
                    <Button
                        ...
                        onClick={() =>
                            auth && auth.userId
                                ? AddToCartMutation.mutate(productDetails)
                                : addToLocalCartDispatch(productDetails)
                        }
                    >
                ...
                <Button
                    variant="outline"
                    className={`group w-full active:scale-[.99] rounded-full flex items-center bg-white justify-center border border-gray-300 gap-3 transition-all shadow-sm duration-300 ${
                    ...
                    onClick={() =>
                        auth && auth.userId
                            ? isProductFavorite(_id)
                                ...
                                : addProductToWishListMutation.mutate(_id)
                            : toggleFavorite(productDetails)
                    }
                >
                    <Heart
                        size={24}
